...
var qrcode = function() {
    ...
    var g = {
        ...
        setWebcam: function(a) {
            var b = navigator;
            g.video = document.getElementsByTagName('qr-reader')[0].shadowRoot.getElementById(a);
            var e = !0;
        ...
        decode: function(a) {
            if (0 == arguments.length) {
                if (g.canvas_qr2) {
                    ...
                    b = document.getElementsByTagName('qr-reader')[0].shadowRoot.getElementById("qr-canvas"),
                    e = b.getContext("2d");
                g.width = b.width;
                g.height = b.height;
            ...
            d.onload = function() {
                var a = document.getElementsByTagName('qr-reader')[0].shadowRoot.getElementById("out-canvas");
